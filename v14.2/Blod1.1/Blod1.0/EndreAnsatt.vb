...
Public Class EndreAnsatt
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Endre_info.Click
    ...
    Private Sub EndreAnsatt_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
