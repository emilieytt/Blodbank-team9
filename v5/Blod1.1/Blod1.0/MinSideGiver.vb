...
Public Class MinSideGiver
    ...
    Private tilkobling4 As MySqlConnection
    Private Sub MinSideGiver_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        tilkobling4 = New MySqlConnection("Server=mysql.stud.iie.ntnu.no;" &
                                             "Database=g_oops_09;" &
                                             "Uid=g_oops_09;" &
                                             "Pwd=IxKu1h4H;")
        tilkobling4.Open()
        ...
        Try
            ...
            Dim sqlgiver As New MySqlCommand(giverSporring, tilkobling4)
