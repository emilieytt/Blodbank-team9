...
Public Class MinSideAdmin
    ...
    End Sub
    Private Sub Add()
        Dim addSql As String = "INSERT INTO Bruker (bruker_type, fodselsdato, f_navn, e_navn, epost, passord, tlf_nr, adresse, postnr, kjonn, epost_godtatt, blodtype) 
        VALUES ('" & Endre_brukertype.Text & "','" & Endre_fodselsdato.Text & "','" & Endre_fornavn.Text & "', '" & Endre_enavn.Text & "', '" & Endre_epost.Text & "','" & Endre_passord.Text & "',
'" & Endre_tlfnr.Text & "','" & Endre_adresse.Text & "','" & Endre_postnr.Text & "','" & Endre_kjønn.Text & "','" & Epost_godtatt.Text & "', '" & Endre_blodtype.Text & "')"
        '                                VALUES ( @BRUKER_TYPE, @FODSELSDATO, @F_NAVN, @E_NAVN, @EPOST, @PASSORD, @TLF_NR, @ADRESSE, @POSTNR, @KJONN, @EPOST_GODTATT, @BLODTYPE) "
    ...
    Private Sub Endre_kjønn_Validated(sender As Object, e As EventArgs) Handles Endre_kjønn.Validated

    End Sub

    Private Sub Endre_kjønn_TextChanged(sender As Object, e As EventArgs) Handles Endre_kjønn.TextChanged
